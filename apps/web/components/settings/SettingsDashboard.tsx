...
import { IconBuilding, IconDownload, IconUsersGroup, IconWorld } from "@tabler/icons-react";
...
export default function SettingsDashboard() {
  const [tab, setTab] = useState<"profil" | "tim" | "domain" | "data">("profil");

  return <main style={page}>
    <header><p style={eyebrow}>PENGATURAN</p><h1 style={title}>Pengaturan</h1><p style={{ color: "var(--color-warm-500)", margin: 0 }}>4 area pengaturan · {tab === "profil" ? "Profil Operator" : tab === "tim" ? "Tim & Anggota" : tab === "domain" ? "Domain" : "Ekspor Data Saya"} sedang dibuka</p></header>

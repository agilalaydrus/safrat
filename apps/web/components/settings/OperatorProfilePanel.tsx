...
import type { StorefrontArticle, StorefrontContent, StorefrontPackage, StorefrontPublicPackage, StorefrontSeason, StorefrontSocialLink, StorefrontTheme } from "@/components/storefront/TenantStorefront";

type Tab = "brand" | "packages" | "gallery" | "social" | "trust" | "publishing";

const EMPTY_CONTENT: StorefrontContent = { brandColor: "#059669", theme: { ...DEFAULT_STOREFRONT_THEME }, packages: [], publicPackages: [], gallery: [], socialLinks: [], testimonials: [], faqs: [], news: [], blogPosts: [] };

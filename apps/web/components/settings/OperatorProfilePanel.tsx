...
import type { StorefrontArticle, StorefrontContent, StorefrontPackage, StorefrontPublicPackage, StorefrontSeason } from "@/components/storefront/TenantStorefront";

type Tab = "brand" | "packages" | "gallery" | "trust" | "publishing";

const EMPTY_CONTENT: StorefrontContent = { brandColor: "#059669", packages: [], publicPackages: [], gallery: [], testimonials: [], faqs: [], news: [], blogPosts: [] };

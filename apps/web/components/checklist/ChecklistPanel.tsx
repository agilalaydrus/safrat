...
const tabActive: React.CSSProperties = { minHeight: 40, border: "1px solid var(--color-emerald-900)", borderRadius: 8, background: "var(--color-emerald-900)", color: "white", fontWeight: 700, padding: "0 16px" };

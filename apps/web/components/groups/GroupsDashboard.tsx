...
export default function GroupsDashboard(){
  ...
  return <main style={page}>
    ...
    )}</div>:<section style={empty}><IconUsersGroup size={48} color="var(--color-warm-400)"/><h2 style={{margin:0}}>Belum ada grup</h2><p>Buat grup untuk mengelompokkan jamaah dan menetapkan Muttawwif.</p><button style={gold} onClick={()=>setOpen(true)}>Tambah Grup</button></section>}

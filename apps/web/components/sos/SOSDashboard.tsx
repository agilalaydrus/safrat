...
const ackButton: React.CSSProperties = { minHeight: 40, border: "1px solid var(--color-emerald-700)", borderRadius: 12, padding: "0 14px", background: "var(--color-emerald-50)", color: "var(--color-emerald-900)", display: "inline-flex", alignItems: "center", gap: 6, fontWeight: 700 };

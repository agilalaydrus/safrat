...
export default function CashFlowDashboard() {
  ...
  return <main className="cashflow-page">
    ...
    <PlanDetailDrawer detail={selected} onClose={() => { setSelected(undefined); setReversing(undefined); }} paymentForm={paymentForm} setPaymentForm={setPaymentForm} onRecord={() => void recordPayment()} saving={saving} reversing={reversing} setReversing={(payment) => { setReversing(payment); setReversalReason(""); setReversalKey(nextKey()); }} reversalReason={reversalReason} setReversalReason={setReversalReason} onReverse={() => void reversePayment()} reversedPaymentIDs={reversedPaymentIDs} />

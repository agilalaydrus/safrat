...
const approveBtn: React.CSSProperties = { minHeight: 32, border: "1px solid var(--color-emerald-700)", borderRadius: 8, padding: "0 10px", background: "var(--color-emerald-50)", color: "var(--color-emerald-900)", fontSize: 12, fontWeight: 600, display: "inline-flex", alignItems: "center", gap: 4, whiteSpace: "nowrap" };

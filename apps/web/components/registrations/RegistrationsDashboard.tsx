...
const copyButton: React.CSSProperties = { minHeight: 36, border: "1px solid var(--color-emerald-700)", borderRadius: 8, background: "transparent", color: "var(--color-emerald-900)", fontWeight: 700, padding: "0 14px", flexShrink: 0 };
...
const approveBtn: React.CSSProperties = { minHeight: 40, border: "1px solid var(--color-emerald-700)", borderRadius: 8, background: "var(--color-emerald-50)", color: "var(--color-emerald-900)", fontWeight: 700, padding: "0 14px", display: "inline-flex", gap: 6, alignItems: "center" };

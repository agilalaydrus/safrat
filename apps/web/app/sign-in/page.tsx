...
// See /sign-up: the key deliberately resets PublicOnly's one-time session
// probe whenever a visitor changes auth mode.
export default function SignInPage(){return <PublicOnly key="sign-in"><main style={page}><div style={card}><div style={brand}><Link href="/" aria-label="Tawafiq Hub home" style={logo}>Tawafiq Hub</Link><p style={tagline}>Setiap perjalanan dimulai di sini</p></div><div className="gold-divider"/><h2 style={heading}>Masuk ke akun Anda</h2><p style={sub}>Masukkan kredensial Anda untuk mengakses dashboard</p><AuthForm mode="sign-in"/><p style={footer}>Belum punya akun? <Link href="/sign-up" style={footerLink}>Buat akun</Link></p></div></main></PublicOnly>;}

...
const FEATURES = [
  ...
  { icon: IconShoppingCart, title: "Produk Digital & Pembayaran", desc: "Jual paket roaming dan layanan tambahan lewat checkout terintegrasi — dari jamaah langsung, atau dicatat manual oleh admin." },
  ...
  { icon: IconDeviceMobile, title: "Aplikasi Ketua Rombongan & Jamaah", desc: "PWA ringan untuk chat, check-in, dan SOS — langsung dari browser, tanpa install dari toko aplikasi." },
];
...
export default function LandingPage() {
  ...
  return (
    <div style={page}>
      ...
      <section style={hero}>
        <IslamicPattern id="safrat-star-hero" opacity={0.1} />
        <div style={heroGlow} />
        <div style={heroInner}>
...
const nav: React.CSSProperties = { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "16px 32px", position: "sticky", top: 0, background: "rgba(6,31,20,.72)", backdropFilter: "blur(10px)", WebkitBackdropFilter: "blur(10px)", zIndex: 20, borderBottom: "1px solid rgba(201,168,76,.18)" };
...
const navLink: React.CSSProperties = { fontSize: 13, fontWeight: 500, color: "rgba(253,249,240,.75)" };
...
const hero: React.CSSProperties = {
  ...
  background: "radial-gradient(1100px 560px at 50% -12%, rgba(212,184,106,.22), transparent 60%), radial-gradient(760px 480px at 88% 8%, rgba(26,92,58,.55), transparent 62%), linear-gradient(180deg, #0d3d27 0%, #061f14 100%)",
  overflow: "hidden",
};
const heroGlow: React.CSSProperties = { position: "absolute", inset: 0, background: "radial-gradient(420px 220px at 50% 30%, rgba(212,184,106,.14), transparent 70%)", pointerEvents: "none" };
const heroInner: React.CSSProperties = { position: "relative", maxWidth: 720, margin: "0 auto" };
const eyebrow: React.CSSProperties = { fontSize: 11, fontWeight: 700, letterSpacing: ".14em", color: "var(--color-gold-400)", marginBottom: 18 };
const heroTitle: React.CSSProperties = { fontFamily: "'Fraunces', 'Playfair Display', serif", fontOpticalSizing: "auto", fontSize: "clamp(40px,7.5vw,72px)", fontWeight: 600, color: "var(--color-cream-100)", lineHeight: 1.08, marginBottom: 22, letterSpacing: "-.01em" };
const heroSub: React.CSSProperties = { fontSize: 17, color: "rgba(253,249,240,.72)", maxWidth: 540, margin: "0 auto 34px", lineHeight: 1.7 };
const ctaRow: React.CSSProperties = { display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap", minHeight: 48 };
const heroCta: React.CSSProperties = { display: "inline-flex", alignItems: "center", gap: 8, background: "linear-gradient(135deg, var(--color-gold-400), var(--color-gold-600))", color: "var(--color-warm-900)", fontWeight: 700, fontSize: 15, padding: "14px 26px", borderRadius: 9, boxShadow: "0 8px 24px -6px rgba(201,168,76,.55)" };
const heroOutline: React.CSSProperties = { display: "inline-flex", alignItems: "center", fontWeight: 700, fontSize: 15, padding: "14px 26px", borderRadius: 9, background: "transparent", color: "var(--color-cream-100)", border: "1.5px solid rgba(253,249,240,.35)" };
const badgeRow: React.CSSProperties = { display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 8, marginTop: 40 };
const badge: React.CSSProperties = { fontSize: 12, fontWeight: 600, color: "rgba(253,249,240,.85)", background: "rgba(253,249,240,.06)", border: "1px solid rgba(212,184,106,.28)", borderRadius: 999, padding: "6px 14px", backdropFilter: "blur(4px)" };
...
const banner: React.CSSProperties = { position: "relative", background: "radial-gradient(900px 500px at 50% 110%, rgba(212,184,106,.18), transparent 60%), linear-gradient(180deg, #061f14 0%, #0d3d27 100%)", textAlign: "center", padding: "88px 32px", overflow: "hidden" };

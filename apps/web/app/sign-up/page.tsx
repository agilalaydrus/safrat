...
// Sign-in and sign-up render the same PublicOnly component. Give each route a
// stable, distinct key so moving between them cannot retain a completed (or
// pending) session check from the other page and leave the form looking stuck.
export default function SignUpPage(){return <PublicOnly key="sign-up"><main style={page}><div style={card}><div style={brand}><Link href="/" aria-label="Tawafiq Hub home" style={logo}>Tawafiq Hub</Link><p style={tagline}>Setiap perjalanan dimulai di sini</p></div><div className="gold-divider"/><h2 style={heading}>Buat akun Anda</h2><p style={sub}>Mulai kelola operasional Haji & Umrah Anda</p><AuthForm mode="sign-up"/><p style={footer}>Sudah punya akun? <Link href="/sign-in" style={footerLink}>Masuk</Link></p></div></main></PublicOnly>;}

...
const submitStyle: React.CSSProperties = { width: "100%", minHeight: 44, background: "var(--color-gold-500)", color: "#fff", border: "none", borderRadius: 8, fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: "'Plus Jakarta Sans',sans-serif" };
const primaryLink: React.CSSProperties = { display: "block", width: "100%", minHeight: 44, lineHeight: "44px", background: "var(--color-gold-500)", color: "#fff", borderRadius: 8, fontSize: 14, fontWeight: 700, textDecoration: "none" };

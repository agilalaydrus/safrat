...
import { IconBuildingStore, IconCurrencyDollar, IconShieldLock, IconAlertTriangle, IconTruckDelivery, IconPackage, IconBuildingBank, IconReceipt2, IconUsers, IconId, IconAdjustments, IconPlugConnected, IconCalendarDollar, IconGauge, IconFilter } from "@tabler/icons-react";
...
export default function PlatformAdminPage() {
  ...
  const [tab, setTab] = useState<"transactions" | "operators" | "catalogue" | "transfers" | "costs" | "suppliers" | "accounts" | "identity" | "quotas" | "routing" | "subscriptions" | "usage" | "funnel">("transactions");

...
const primary: React.CSSProperties = { minHeight: 44, border: 0, borderRadius: 10, background: "var(--color-gold-500)", color: "var(--color-warm-900)", fontWeight: 700, marginTop: 4 };
